...
args.add_argument('--use_hypergraph', default=config['model']['use_hypergraph'], type=eval)
args.add_argument('--use_interactive', default=config['model']['use_interactive'], type=eval)
args.add_argument('--num_hyper_edges', default=config['model']['num_hyper_edges'], type=int)
#train
